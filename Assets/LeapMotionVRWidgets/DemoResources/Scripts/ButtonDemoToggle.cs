...
public class ButtonDemoToggle : ButtonToggleBase 
{
    ...
    public ElectricalController electricalController;
      

    public override void ButtonTurnsOn()
    {
      TurnsOnGraphics();
      electricalController.TurnOn();
    }

    public override void ButtonTurnsOff()
    {
      TurnsOffGraphics();
      electricalController.TurnOff();
    }
    ...
    public override void Awake()
    {
      base.Awake();
      TurnsOffGraphics();
      electricalController = GameObject.FindGameObjectWithTag("ElectricalController").GetComponent<ElectricalController>();
    }
